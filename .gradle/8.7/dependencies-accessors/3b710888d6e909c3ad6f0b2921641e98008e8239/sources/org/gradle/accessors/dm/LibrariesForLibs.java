...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>detekt</b> with <b>io.gitlab.arturbosch.detekt:detekt-cli</b> coordinates and
    ...
    public static class AndroidxWorkLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>work.multiprocess</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.test</b> with value <b>1.6.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class WorkVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("work"); }

        /**
         * Version alias <b>work.multiprocess</b> with value <b>2.9.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMultiprocess() { return getVersion("work.multiprocess"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        private final DetektPluginAccessors paccForDetektPluginAccessors = new DetektPluginAccessors(providers, config);
        ...
        /**
         * Group of plugins at <b>plugins.detekt</b>
         */
        public DetektPluginAccessors getDetekt() {
            return paccForDetektPluginAccessors;
        }
        ...
        /**
         * Group of plugins at <b>plugins.ktlint</b>
         */
    ...
    public static class DetektPluginAccessors extends PluginFactory {

        public DetektPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Plugin provider for <b>detekt.gradle</b> with plugin id <b>io.gitlab.arturbosch.detekt</b> and
         * with version reference <b>detekt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getGradle() { return createPlugin("detekt.gradle"); }
    ...
    public static class KtlintPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>ktlint.gradle</b> with plugin id <b>org.jlleitschuh.gradle.ktlint</b> and
         * with version reference <b>ktlint</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
