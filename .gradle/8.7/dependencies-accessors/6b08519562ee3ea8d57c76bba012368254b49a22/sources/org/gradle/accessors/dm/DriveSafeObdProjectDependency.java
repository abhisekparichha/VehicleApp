...
@NonNullApi
public class DriveSafeObdProjectDependency extends DelegatingProjectDependency {

    @Inject
    public DriveSafeObdProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
